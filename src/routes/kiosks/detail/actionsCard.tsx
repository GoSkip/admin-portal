  ...
  return (
    <div className="space-y-10 divide-y divide-gray-900/10 mt-4 mb-4 col-span-4">
      <div className="text-gray-600 bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl sm:rounded-xl grid grid-cols-4">
        <div className="col-span-1 text-left bg-gray-100 rounded-tl-xl pl-6 py-2">ACTOR</div>
        <div className="col-span-1 text-left bg-gray-100 pl-3 py-2">ACTION TYPE</div>
        <div className="col-span-1 text-left bg-gray-100 pl-3 py-2">TIMESTAMP</div>
        <div className="col-span-1 text-left bg-gray-100 rounded-tr-xl pl-3 py-2">METADATA</div>
        {actions.length > 0 ? (
          <>
            {actions
          ...
          <p className="text-center col-span-4 mt-4 mb-4 font-semibold">No actions found for this iPad.</p>
        )}
      </div>
    </div>
  );
