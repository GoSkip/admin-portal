...
const Login = (): JSX.Element => {
  ...
  const isNotReady = isLoading || emailIsInvalid || username === "" || password === "";

  return (
    <>
      <div className={"grid grid-col-1 lg:grid-cols-2 lg:ml-20 min-h-auto content-center ease-in duration-100"}>
        <div className="w-96 self-center justify-self-center">
          <div className="mb-8">
            <div>
              <img className="mb-6" src={standard_logo} alt="Standard Logo" />
              <h2 className="text-3xl font-extrabold tracking-light text-gray-900">POS^ Admin Portal</h2>
              <h3 className="mt-3 text-sm font-light text-gray-600">Sign in to your account</h3>
            </div>
            ...
            <div className="mt-6">
              <form className="space-y-6" onSubmit={doLogin}>
                  ...
                  <div className="relative mt-1 rounded-md shadow-sm">
                    <input
                      ...
                      className={classNames(
                        emailIsInvalid ? "focus:ring-red-600" : "focus:ring-indigo-600",
                ...
                <div className="flex-row items-center justify-center">
                  ...
                  >
                    <div className="mr-2 flex items-center text-white font-light">Sign in</div>
                  </button>
