    ...
    <div>
      <div className="flow-root w-[calc(100%-18rem)]">
        <div className="flex flex-row mb-4">
          ...
          <div className="flex-initial">
            <select className="text-right pr-4 py-1 rounded-md bg-white outline outline-1 outline-gray-300 text-md font-medium text-gray-600">
        ...
        <div className="float-left bg-white w-[calc(100%-18rem)] shadow-md rounded-md">
          <div className="m-5">
            ...
            <div className="flex flex-row items-center space-x-2 my-4">
              <button className="rounded-full bg-[#d1fae5] text-[#065f46] px-2 py-1 text-sm font-medium ">
                + Add store
              </button>
            </div>
          </div>
      ...
      <div className="flow-root w-[calc(100%-18rem)]">
        ...
        <div className="flex flex-row justify-end space-x-2 mt-5">
          <button className="border rounded-md bg-white text-sm font-light px-3 py-2 border-1 border-gray-300">
            Discard
          </button>
          <button className="border rounded-md bg-[#0284C7] text-sm text-white font-light px-3 py-2 border-1 border-gray-300">
            Save
          </button>
        </div>
      </div>
