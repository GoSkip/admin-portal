  ...
  return (
    <div className="cursor-pointer flex justify-center rounded-lg border-2 border-dashed border-gray-300 px-6 py-12">
      <div className="text-center">
        <Icon path={mdiFileUploadOutline} className="mx-auto text-gray-400" size={2.5} />
...
export const DragDropFileArea: FC<DragDropFileAreaType> = ({ types = [], maxSize = 0, initFile = null, onChange }) => {
  const { t } = useTranslation();
    ...
    return (
      <div className="p-6 border-2 border-gray-300 border-dashed rounded-xl flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <IconButton color="gray-400" icon={mdiCloseCircle} size={1} onClick={() => handleChange(null)}></IconButton>
        </div>
      </div>
    );
  }
  return (
    <FileUploader
      ...
      children={<FileUploaderInner types={types} maxSize={maxSize}></FileUploaderInner>}
    />
  );
};
